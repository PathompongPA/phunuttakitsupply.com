...
export default function Navbar({ category }: prop) {
    ...
    return (
        <nav className={`fixed lg:py-2 top-0 left-0 w-screen flex justify-center duration-600 ease-in-nav ${lastScrollY === 0 ? " bg-transparent " : "bg-white"}  data-[hidden=true]:scale- origin-center data-[hidden=true]:-top-full z-50 `} aria-label="main navigation" data-hidden={hidden} data-position={lastScrollY} >
