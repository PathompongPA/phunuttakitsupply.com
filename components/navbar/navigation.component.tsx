...
export default function NavigationBar({ search = false }: prop) {
    ...
    return (
        <nav className="flex gap-2 text-[14px] lg:text-[12px] w-full text-white bg-orange px-4 py-3 items-center justify-center lg:px-16 z-30">
            <div className="lg:max-w-7xl lg:px-16 flex w-full gap-16 ">
