...
export default function NavigationBar({ search = false }: prop) {
    ...
    return (
        <nav className="flex gap-2 text-[10px] md:text-[10px] lg:text-[12px] w-full text-white bg-orange px-4 py-4 items-center justify-center lg:px-0 z-30 ">
            <div className="lg:max-w-7xl lg:px-4 flex w-full gap-2 ">
