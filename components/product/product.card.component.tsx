...
export default function ProductCard({ name, thumbnail, brand, category, type, brandImage, pathname }: prop) {
    ...
    return (
        <Link href={{ pathname }} className="flex flex-col justify-between bg-white  border-2 duration-300 ease-in-expo border-transparent  shadow-gray-3/90  rounded-lg relative active:scale-90    lg:hover:border-gray lg:hover:border-2 overflow-hidden group  ">
            {brandImage &&
