...
export const metadata = generateSEO({
    title: "เกี่ยวกับเรา บริษัท ภูณัฐกิจ ซัพพลาย จำกัด | ซัพพลายเออร์สินค้าโรงงานอุตสาหกรรม",
    description: "ทำความรู้จัก บริษัท ภูณัฐกิจ ซัพพลาย จำกัด ผู้เชี่ยวชาญด้านการนำเข้า จัดหาและจัดจำหน่ายสินค้าโรงงาน เครื่องจักรกลอุตสาหกรรม มอเตอร์ไฟฟ้า ปั๊มน้ำ วาล์ว ระบบบาร์โค้ดครบวงจร รวมถึงบริการซ่อมมอเตอร์ไฟฟ้าอุตสาหกรรม ด้วยประสบการณ์ที่ยาวนาน มุ่งมั่นส่งมอบสินค้าตามมาตรฐาน",
})
